...
const Track = ({ id, title = 'Untitled', volume = 0, isMuted = false, isEffectsDisabled = false, send = {}, onMute = () => { }, onBypass = () => { }, onVolumeChange = () => { }, onSendLevelChange = () => { }, }) => (React.createElement("div", { className: style.track },
