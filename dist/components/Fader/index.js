...
const Fader = ({ value = 0, isVertical = false, onChange = () => { }, }) => {
    ...
    return (React.createElement("div", { className: classnames(style.fader, !isVertical && style.isHorisontal), ref: containerRef },
        React.createElement("div", { className: style.control },
            React.createElement(FaderThumb, { position: value, events: { [thumbEventName]: onMoveStart }, isVertical: isVertical }))));
};
